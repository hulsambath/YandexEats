...
class $AssetsFontsGen {
  ...
  /// File path: assets/fonts/noto_serif_khmer.ttf
  String get notoSerifKhmer =>
      'packages/app_ui/assets/fonts/noto_serif_khmer.ttf';

  /// List of all assets
  List<String> get values => [notoSerifKhmer];
}
